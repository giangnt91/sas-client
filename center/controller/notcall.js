sas
    .controller('NotcallCtrl', function ($location, $scope, $rootScope, Notifi, ngDialog, $timeout, DataServices, md5, DTOptionsBuilder, Thesocket, SMSService) {
        // hiển thị ngày tháng
        ...
        $scope.Searchwith = function () {
            ...
            var _nregday = $('#nregday').val();
            var _nregday2 = $('#nregday2').val();
            ...
            DataServices.SearchN($rootScope.auth.Role, nregday, nregday2, $rootScope.auth.Username).then(function (response) {
                if (response.data.error_code === 0) {
					$timeout(function(){
